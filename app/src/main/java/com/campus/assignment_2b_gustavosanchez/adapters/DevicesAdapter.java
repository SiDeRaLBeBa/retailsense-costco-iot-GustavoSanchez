...
public class DevicesAdapter extends RecyclerView.Adapter<DevicesAdapter.DeviceViewHolder> {
    ...
    public interface OnDeviceClickListener {
        ...
        void onOverflowClick(Device device);
    }

    public DevicesAdapter(Context context, List<Device> devices, OnDeviceClickListener listener) {
    ...
    public void onBindViewHolder(DeviceViewHolder holder, int position) {
        ...
        holder.type.setText(device.getType() + " • " + device.getStore());
        holder.status.setText(device.getStatus());
        holder.lastHeartbeat.setText(device.getLastHeartbeat());

        holder.itemView.setOnClickListener(v -> listener.onDeviceClick(device));
        holder.overflow.setOnClickListener(v -> listener.onOverflowClick(device));
    }
    ...
    static class DeviceViewHolder extends RecyclerView.ViewHolder {
        TextView label, type, status, lastHeartbeat, overflow;
        public DeviceViewHolder(View itemView) {
            ...
            overflow = itemView.findViewById(R.id.deviceOverflow);
        }
    }
}
